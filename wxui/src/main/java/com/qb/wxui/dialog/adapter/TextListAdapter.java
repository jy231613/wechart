 ...
 */
public class TextListAdapter extends RecyclerView.Adapter<TextListAdapter.ViewHolder> implements View.OnClickListener{
    private List<RecyclerBean> items;
    private Context context;

    //构造方法,用于传入数据参数
    public TextListAdapter(List<RecyclerBean> beans, Context context) {
        this.items = beans;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_text_list_item,viewGroup,false);
